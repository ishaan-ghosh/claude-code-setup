...
5. **Implement** — proceed with the normal development workflow (TDD applies: use the dev-setup:tdd skill); no plan document
...
<!-- dev-setup adaptation: the upstream browser-based Visual Companion (visual-companion.md, scripts/) is not vendored; brainstorming is text-only in this plugin. The bounded path's TDD note points at dev-setup:tdd. -->
